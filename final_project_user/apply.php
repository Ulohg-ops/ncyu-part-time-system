				...
				<form action="apply2.php" method="post">
					...
					<div class="user-details">
						<div class="input-box">
							...
							<input type="text" placeholder="Enter your name"  name="name" value="<?php echo $_SESSION['name'] ;?>" readonly>
						</div>
						<div class="input-box">
						...
						<div class="input-box">
							...
							<input type="date" placeholder="yy/mm/dd"  id="date" name="birthday" value="<?php  echo $birthday ?>"readonly>
						</div>
						<div class="input-box">
							<span class="details">電子信箱</span>
							<input type="text" placeholder="Enter your email" class="email"
							name="email" value="<?php echo $email ;?>"readonly>
						</div>
						<div class="input-box">
							<span class="details">手機號碼</span>
							<input type="text" placeholder="Enter your number" class="phone"
							name="phone" value="<?php echo $phone ;?>"readonly>
						</div>
						<div class="input-box">
						...
						<div class="input-box">
							...
							value="<?php echo $telephone ;?>"readonly> <!--required /*not empty*/ -->
						</div>
					...
					<div class="user-grades">
						...
						<div class="input-box">
							...
							<input class="grade_placeholder" type="text" placeholder="first " name="first_grade" value="<?php echo $first_grade ;?>"readonly>
						</div>
						<div class="input-box">
							<span class="grade">下學期學業成績</span>
							<input class="grade_placeholder" type="text" placeholder="second" name="second_grade" value="<?php echo $second_grade ;?>"readonly>
						</div>
						<div class="input-box">
							<span class="grade">上學期操行成績</span>
							<input class="grade_placeholder" type="text" placeholder="first" name="first_conduct_grade" value="<?php echo $first_conduct_grade ;?>"readonly>
						</div>
						<div class="input-box">
							<span class="grade">下學期操行成績</span>
							<input class="grade_placeholder" type="text" placeholder="second " name="second_conduct_grade" value="<?php echo $second_conduct_grade ;?>"readonly>
						</div>
					</div>
					<!------------- radio button --------------->
